...
public final class FindbugsEclipseConstants {
	...
	public static final String ECLIPSE_FB_PREFS_CONFIG_NAME = "findbugs-maven-plugin";
	public static final String ECLIPSE_FB_NATURE_ID = "edu.umd.cs.findbugs.plugin.eclipse.findbugsNature";
