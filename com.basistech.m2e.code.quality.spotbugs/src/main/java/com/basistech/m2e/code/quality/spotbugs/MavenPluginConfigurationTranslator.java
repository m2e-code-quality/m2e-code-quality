...
import static com.basistech.m2e.code.quality.spotbugs.SpotbugsEclipseConstants.LOG_PREFIX;
import static com.basistech.m2e.code.quality.spotbugs.SpotbugsEclipseConstants.MAX_RANK;
import static com.basistech.m2e.code.quality.spotbugs.SpotbugsEclipseConstants.OMIT_VISITORS;
...
/**
 * Utility class to get spotbugs plugin configuration.
 */
public class MavenPluginConfigurationTranslator {
	 ...
	 * the project.
	 * <p>
	 * This the only reference I could find on how the Spotbugs Eclipse Plugin
	 * configuration works.
	 * </p>
	 * 
	 * @param resc
